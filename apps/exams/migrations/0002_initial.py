...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='subjectresult',
            name='grade',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='exams.grade', verbose_name='Grade'),
        ),
        migrations.AddField(
            model_name='subjectresult',
            name='tenant',
        ...
        migrations.AddField(
            model_name='grade',
            name='grading_system',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grades', to='exams.gradingsystem', verbose_name='Grading System'),
        ),
        migrations.AddField(
            model_name='grade',
            name='tenant',
        ...
        migrations.AddField(
            model_name='examresult',
            name='overall_grade',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='exams.grade', verbose_name='Overall Grade'),
        ),
        migrations.AddField(
            model_name='examresult',
            name='student',
        ...
        migrations.AddField(
            model_name='compartmentexam',
            name='improved_grade',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='exams.grade', verbose_name='Improved Grade'),
        ),
        migrations.AddField(
            model_name='compartmentexam',
        ...
        migrations.AddIndex(
            model_name='grade',
            index=models.Index(fields=['grading_system', 'min_percentage', 'max_percentage'], name='exams_grade_grading_2dfeaf_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='grade',

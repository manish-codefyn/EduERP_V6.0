...
# Subdomains to ignore for tenant detection
IGNORED_SUBDOMAINS = [
    'www',
    'api',
    'admin',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # OR use combined:
                # 'tenants.context_processors.combined_context',
            ],
             "libraries": {
...
DASHBOARD_CONFIG = {
    'STAFF_ROLES': [
        'teacher', 'staff', 'principal', 'headmaster', 'accountant', 
    ...
    'DEFAULT_REDIRECTS': {
        'student': 'student_portal_dashboard',
        'parent': 'student_portal_dashboard',
        'teacher': 'staff_dashboard',
        'admin': 'admin_dashboard',
        'super_admin': 'system_admin_dashboard',
    },
